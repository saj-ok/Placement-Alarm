    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12" style={{ animation: "fadeInUp 0.8s ease-out" }}>
        ...
        <div className="bg-gray-800/40 backdrop-blur-xl rounded-3xl border border-gray-700/50 shadow-2xl overflow-hidden">
          {/* Header Section */}
          <div className="relative bg-gradient-to-r from-purple-600/20 via-pink-600/20 to-blue-600/20 p-8 border-b border-gray-700/50">
            ...
            <div className="relative flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  />
                  <div className="absolute -bottom-2 -right-2 p-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full shadow-lg">
              ...
              {!isEditing ? (
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white border-0 shadow-xl hover:shadow-2xl hover:shadow-purple-500/30 transition-all duration-300 transform hover:scale-105 rounded-full px-6 py-3"
                >
